...
# FireBase Access
To access to database of this Web App, you need to send an email to Kristine to get access to the database. The owner can use the link in the google doc to add new member to access the database. When you first use the database, you need click on 'Get Start' and you can see recent projects. In that, you can find deliberate prject and click on it. After entering the database, on the left side, you can click on 'database', and you will see all the data.
